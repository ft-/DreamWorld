Public Class Handler
    ...
    Dim Exitlist1 As New List(Of Integer)
    ...
    End Sub
    Public Function Init(ByVal RegionHandles As Dictionary(Of Integer, String), ByVal ExitList As List(Of Integer)) As Process
